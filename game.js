...
//Add the contents of the variable userChosenColour created before to the end of this new userClickedPattern
...
//Add the new randomChosenColour generated before to the end of the gamePattern.
  gamePattern.push(randomChosenColour);

//Use jQuery to select the button with the same id as the randomChosenColour
//Use Google/Stackoverflow to figure out how you can use jQuery to animate a flash to the button selected before.
